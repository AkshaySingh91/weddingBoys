...
const VideoPlayer = ({ src }) => {
  ...
  const handleSpeedChange = (e) => {
    ...
    if (Number.parseInt(e.target.value) !== NaN) {
      ...
      video.playbackRate = Number.parseInt(e.target.value)
      setIsSpeedSettingOpen(false)
    }
  };
  ...
  return (
    <div ref={containerRef} className="relative bg-black lg:h-[90%] transition-transform duration-100  rounded-t-xl md:h-[70%] lg:ml-4 aspect-[16/9] w-full max-w-md sm:max-w-lg md:max-w-2xl lg:max-w-4xl xl:max-w-6xl mx-auto">
      <video
