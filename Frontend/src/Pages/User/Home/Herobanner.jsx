    ...
    return (
        <>
            ...
            <div className="hero-banner w-auto lg:h-[33rem] relative rounded-2xl sm:h-[33rem] overflow-hidden">
                                ...
                                <div key={video.videoKey} className="flex-shrink-0 h-full w-full relative" >
                                    ...
                                    <Link to={`/films/${video.videoId}`}>
                                        <div className="absolute lg:bottom-8 lg:left-8 text-white flex flex-col gap-0 sm:left-4 sm:bottom-4">
                                            ...
                                            <div className="flex items-center lg:text-lg uppercase font-light tracking-wide sm:text-mobileHeadlineSmall">
                ...
                <button
                    className="focus:outline-none focus:border-none left-video absolute left-4 top-1/2 transform -translate-y-1/2 bg-white text-gray-700 rounded-full p-2 shadow-md hover:bg-gray-200" onClick={handlePrev}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" className="w-6 h-6">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M15 19l-7-7 7-7" />
                    </svg>
                </button>
                <button
                    className="focus:outline-none focus:border-none right-video absolute right-4 top-1/2 transform -translate-y-1/2 bg-white text-gray-700 rounded-full p-2 shadow-md hover:bg-gray-200" onClick={handleNext}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" className="w-6 h-6">
