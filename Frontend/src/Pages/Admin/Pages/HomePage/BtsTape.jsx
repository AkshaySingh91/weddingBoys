...
export default function BtsTape() {
    ...
    const handleSave = async (e) => {
        ...
        const saveClientDetails = async (filesMetaWithKey) => {
            try {
                const res = await fetch("http://localhost:5000/admin/api/homepage/bts-image/save-details", {
                    method: "PUT",
                    body: JSON.stringify({
                        filesMetaWithKey
                    }),
        ...
        const verifyDetails = async () => {
            try {
                const res = await fetch("http://localhost:5000/admin/api/homepage/bts-image/get-url", {
                    method: "PUT",
    ...
    const deleteBtsImage = async (key) => {
        try {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    try {
                        const res = await fetch("http://localhost:5000/admin/api/homepage/bts-image", {
                            method: "DELETE",
